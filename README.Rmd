...
* __Future wishlist:__ Add soil nurients change map
...
* Switch from dygraphs to plotly graphics
* __Wishlist:__ Add info about steelhead, water quality data
...
* __TO DO:__ Update text on all pages to provide context relative to SMART goals and region (e.g. grassland bird declines)
