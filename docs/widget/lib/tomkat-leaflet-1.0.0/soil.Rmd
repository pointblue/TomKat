...
#### Since 2015, Point Blue Conservation Science has tested soils across TomKat Ranch. These data allow us to evaluate soil productivity throughout the ranch and track changes over time. As soil productivity impacts occur slowly over time, measurements are taken every three years. Soil points were sampled in either 2015, 2018, 2021, and 2024, or in 2015, 2018, 2022, and 2025. {#intro}

<i>Updated: March 23, 2026</i>
...
&ast;*This goal is may be ambitious due to the ongoing drought conditions in California, which have led to a statewide decline in SOC. Over the monitoring period, drought ranged from moderate (D1) to exceptional drought (D4) occurring in 2014-2016 and 2021-2022. TomKat Ranch Manager, Mark Biaggi, describes it well, "As a kid it was Wet decades interrupted by dry years. Now it is dry decades interrupted by wet years. Our understanding of what is happening hasn't kept up with reality. We need a paradigm shift." With notably low precipitation levels from 2020 to 2022 (see Weather page), any SOC declines on the ranch could still reflect positive impacts, since the rate of decline may be slower than it would have been without restoration efforts.*


### Soil productivity

In 2024 and 2025, we measured three indicators of soil productivity at 22 sampling points: organic carbon content at two depths (0-10cm and 10-40cm), surface soil bulk density, and water infiltration rates. We also produced an overall score combining all three indicators. 

In the map below, each point represents a soil sample location, with colors representing the score for each indicator at the most recent sampling event. For carbon, the inner circle represents the surface soil sample (0-10 cm deep), and the outer circle represents the deeper soil sample (10-40 cm). Two locations where compost was applied are marked with a heavy black border.  
...
We compared data collected at the most recent sampling event (2024 or 2025) to data collected in 2015 to identify sites where productivity indicators have improved or declined. Note that lower values in bulk density and water infiltration represent improvements. Locations where compost was applied are marked with a heavy black border and show an improvement or no change in their overall soil productivity since 2015. Most other points experienced a decline since 2015, likely due to drought conditions in 2020-2022.
