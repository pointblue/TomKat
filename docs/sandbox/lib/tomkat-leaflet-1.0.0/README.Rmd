...
### FUTURE WISHLIST
* Throughout: Add more context linking SMART goals to observations to date
...
* Birds: Add links to wildlife/bird checklists; add photos; add info about banding and Christmas Bird Count surveys; Compare bird densities to management data (difficult with annual sampling effort)
